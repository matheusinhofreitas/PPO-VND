...
#  
GRUPO_INSTANCIA = 150 #10 15 30 50
...
if(GRUPO_INSTANCIA == 150):
    NOME_MODELO = "TREINAMENTO_Defalt_passos_"+str(PASSOS_TREINAMENTO)+"_Recompensa_"+str(TIPO_RECOMPENSA)+"_inst_N_15"
else:
